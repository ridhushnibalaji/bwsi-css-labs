...
def main():
    ...
    name = "Ridhushni Balaji" # TODO: Insert your name between the double quotes

    print(f"{name}, Welcome to the CSS course!")
    print("I am a freshman from Texas. I enjoy math and problem solving, and I like painting, arts and crafts, and playing basketball.")
